                                            ...
                                            ? users.map((user, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="text-center">
                                                        <Link to={`/admin/users/edit/${user.idUser}`} className="btn btn-sm btn-primary rounded-sm shadow border-0 me-2">EDIT</Link>
                                                        <button onClick={() => deleteUser(user.idUser)} className="btn btn-sm btn-danger rounded-sm shadow border-0">DELETE</button>
                                                    </td>
                                                </tr>
                                            ))
